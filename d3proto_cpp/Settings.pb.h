...
class ToonSettings : public ::google::protobuf::Message {
 ...
 private:
  inline void set_has_ui_flags();
  inline void clear_has_ui_flags();
...
class GameAccountSettings : public ::google::protobuf::Message {
 ...
 private:
  inline void set_has_use_last_hero();
  inline void clear_has_use_last_hero();
  inline void set_has_show_offline_toast();
  inline void clear_has_show_offline_toast();
...
inline void ToonSettings::set_has_ui_flags() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ToonSettings::clear_has_ui_flags() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void GameAccountSettings::set_has_use_last_hero() {
  _has_bits_[0] |= 0x00000001u;
}
inline void GameAccountSettings::clear_has_use_last_hero() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void GameAccountSettings::clear_use_last_hero() {
  use_last_hero_ = 0;
  clear_has_use_last_hero();
}
...
inline void GameAccountSettings::set_has_show_offline_toast() {
  _has_bits_[0] |= 0x00000002u;
}
inline void GameAccountSettings::clear_has_show_offline_toast() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void GameAccountSettings::clear_show_offline_toast() {
  show_offline_toast_ = 0;
  clear_has_show_offline_toast();
}
